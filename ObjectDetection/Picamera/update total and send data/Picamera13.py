...
class TehseenCode(QDialog):
    ...
    def get_selected_cell(self):
        """Get the currently selected cell in the active Excel sheet."""
        if self.excel_sheet:
            return self.excel_sheet.api.Selection.Address
        return None
    ...
    def send_data_to_excel(self):
        ...
        if selected_cell:
            # Write the total_detected_objects to the selected cell
...
if __name__ == "__main__":
    ...
    excel_file_path = '/home/pi/app/Capture-Image-Python/new_capture/test.xlsx'
